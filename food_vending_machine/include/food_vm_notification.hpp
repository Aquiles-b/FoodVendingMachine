...
template <typename Event> class FoodVmNotification {
  public:
...
FoodVmNotification<Event>::FoodVmNotification(NotificationCallback<Event> callback)
    : m_callback(std::move(callback))
{
}

template <typename Event> void FoodVmNotification<Event>::notify(Event event)
{
